...
public class Board {
	...
	@ManyToOne(fetch=FetchType.EAGER) // Many=Board, User=One // 한 명의 User는 여러개의 게시글을 쓸 수 있다는 의미
	...
	@OneToMany(mappedBy="board", fetch = FetchType.EAGER) // 하나의 게시글은 여러개의 답변이 가능하다.
